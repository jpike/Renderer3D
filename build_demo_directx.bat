...
SET COMPILATION_FILE="..\DirectXDemo.project"
SET MAIN_CODE_DIR="..\code"
SET LIBRARIES=user32.lib gdi32.lib opengl32.lib glu32.lib d3d11.lib dxgi.lib d3dcompiler.lib Renderer3DLibrary.lib
