...
namespace GRAPHICS
{
    ...
    public:
        ...
        static void Render(const Object3D& object_3D, const std::optional<std::vector<Light>>& lights, const Camera& camera, const bool cull_backfaces, Bitmap& output_bitmap);
